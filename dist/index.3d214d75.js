...
var _navigation = require("swiper/css/navigation");
var _pagination = require("swiper/css/pagination");
...
function getData() {
    ...
    if (contactBlock.style.display == "block") contactBlock.style.display = "none";
    else contactBlock.style.display = "block";
    // GET FETCH CONTACT//////////////////////////
